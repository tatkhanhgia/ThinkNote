...
// Map category name (EN + VI with diacritics) to icon key
export const CATEGORY_ICON_KEY: Record<string, string> = {
  ...
  // VI (with diacritics)
  'Ngôn ngữ lập trình': 'code',
  'Lõi phát triển': 'bolt',
  'Trí tuệ nhân tạo': 'cpu',
  'Công cụ': 'wrench',
...
export function getCategoryIcon(categoryName: string): IconFC {
